...
function Header() {
  ...
  return (
    <div className=''>
      <div className='h-50 bg-blue-900 text-white mt-16 mx-auto w-[80%] flex flex-col bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-10 border border-gray-50 rounded-md'>
          ...
          >
            <form onSubmit={handleUserName} className='flex flex-col'>
              ...
              <input
                ...
                type='text'
              />
              <button className='bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-10 border border-gray-50 rounded-md'>
                Save
              </button>
            </form>
          </div>
