...
function SendMessage({ endOfMessages }) {
  ...
  return (
    <form className='flex items-center justify-between fixed bottom-10 w-60 sm:w-11/12 px-2 sm:px-6 py-0.5 sm:py-1 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-10 border border-gray-50 rounded-lg max-w-2xl'>
      <input
